    ...
    public static class CashCollectionsExtensions
    {
       ...
       GetAllCashCollAsync(this IBaseRepository<CashCollection> cashCollectionRepository, IBaseRepository<Customer> customerRepository,
           IBaseRepository<Employee> EmployeeRepository, DateTime fromDate, DateTime toDate)
        {
            ...
            var items = await (from CC in cashCollectionRepository.All
                               join CO in customers on CC.CustomerID equals CO.CustomerID
                               //join EMP in employees on CC.EmployeeID equals EMP.EmployeeID
            ...
            return items.Select(x => new Tuple<int, DateTime, string, string, string, string, string, Tuple<string, string, string>>
                (
                    ...
                    x.TransactionType.ToString(),
                     new Tuple<string, string, string>(x.Remarks, x.Code, x.EmployeeName)
                )).OrderByDescending(x => x.Item1).ToList();
        }

        public static async Task<IEnumerable<Tuple<int, DateTime, string, string, string, string, string, Tuple<string, string, string>>>> GetAllCashCollByEmployeeIDAsync(this IBaseRepository<CashCollection> cashCollectionRepository, IBaseRepository<Customer> customerRepository, IBaseRepository<Employee> EmployeeRepository, int EmployeeID, DateTime fromDate, DateTime toDate
           )
        {
            IQueryable<Customer> customers = customerRepository.All;
            IQueryable<Employee> employees = EmployeeRepository.All;
            ...
            var items = await (from CC in cashCollectionRepository.All
                               join CO in customers on CC.CustomerID equals CO.CustomerID
                               join EMP in employees on CC.EmployeeID equals EMP.EmployeeID
                               where (CC.EntryDate >= fromDate && CC.EntryDate <= toDate && CC.EmployeeID == EmployeeID)
                               select new
                               {
                                   CC.CashCollectionID,
                                   CC.EntryDate,
            ...
            //var items = await cashCollectionRepository.All.Where(i => i.EmployeeID == EmployeeID && i.EntryDate >= fromDate && i.EntryDate <= toDate).Join(customers,
            //    cashcoll => cashcoll.Customer.CustomerID, cus => cus.CustomerID, (cashcoll, cus) => new { CashCollection = cashcoll, Customer = cus }).
            //    Select(x => new
            //    {
            //        x.CashCollection.CashCollectionID,
        ...
        //public static IEnumerable<Tuple<DateTime, string, string, string, decimal, decimal, decimal, Tuple<decimal, string, string, string, string, string, string, Tuple<string>>>>
        ...
        //                                 BKashNo = "",
        //                                 EmployeeName = EMP.Name,
        //                                 InvNo = CC.TransactionNo
        //                             }).OrderByDescending(x => x.EntryDate);

        //        var joinedoCustomerCollData = oCustomerCollData.Concat(oBankCollData).ToList();

        //        return joinedoCustomerCollData.Select(x => new Tuple<DateTime, string, string, string, decimal, decimal, decimal, Tuple<decimal, string, string, string, string, string, string, Tuple<string>>>
        //            (
        //             (DateTime)x.EntryDate,
        //             x.Name,
        //            x.Address,
        ...
        //            x.TotalDue,
        //            x.Amount,
        //            x.RemaingAmt, new Tuple<decimal, string, string, string, string, string, string, Tuple<string>>(
        //                                x.AdjustAmt,
        //                                x.PaymentType.ToString(),
        //                                x.BankName,
        //                               x.AccountNo,
        //                               x.Remarks,
        //                               x.BKashNo,
        //                               x.EmployeeName, new Tuple<string>(
        //                                   x.InvNo))
        //            ));
        ...
        //        return joinedoAllCustomerCollData.Select(x => new Tuple<DateTime, string, string, string, decimal, decimal, decimal, Tuple<decimal, string, string, string, string, string, string, Tuple<string>>>
        //            (
        //             (DateTime)x.EntryDate,
        //             x.Name,
        //            x.Address,
        ...
        //                               x.Remarks,
        //                               x.BKashNo,
        //                               x.EmployeeName, new Tuple<string>(x.InvNo)
        ...
        public static IEnumerable<Tuple<DateTime, string, string, string, decimal, decimal, decimal, Tuple<decimal, string, string, string, string, string, string, Tuple<string, string, string>>>>
    GetSRWiseCashCollectionReportData(
    this IBaseRepository<CashCollection> CashCollectionRepository,
    IBaseRepository<Customer> CustomerRepository,
    IBaseRepository<Employee> EmployeeRepository,
    IBaseRepository<Bank> Bank,
    IBaseRepository<BankTransaction> BankTransaction,
    DateTime fromDate, DateTime toDate, int ConcernID, int EmployeeID)
        {
            if (EmployeeID > 0)
            {
                var oCustomerCollData = (from CC in CashCollectionRepository.All
                                         ...
                                         select new
                                         {
                                             ...
                                             CC.Amount,
                                             RemaingAmt = CC.Amount,
                                             AdjustAmt = CC.AdjustAmt + CC.CashBAmt + CC.YearlyBnsAmt,
                                             PaymentType = "Cash",
                                             CC.BankName,
                                             CC.AccountNo,
                                             Remarks = CC.Remarks,
                                             ...
                                             EmployeeName = EMP.Name,
                                             InvNo = CC.ReceiptNo,
                                             TransactionType = CC.TransactionType.ToString(),
                                             Invoice = CC.InvoiceNo
                                         }).OrderByDescending(x => x.EntryDate);
                ...
                return joinedoCustomerCollData.Select(x => new Tuple<DateTime, string, string, string, decimal, decimal, decimal, Tuple<decimal, string, string, string, string, string, string, Tuple<string, string, string>>>
                (
                    (DateTime)x.EntryDate,
                    x.Name,
                    x.Address,
                    ...
                    x.Amount,
                    x.RemaingAmt,
                    new Tuple<decimal, string, string, string, string, string, string, Tuple<string, string, string>>(
                        x.AdjustAmt,
                        x.PaymentType.ToString(),
                        x.BankName,
                        x.AccountNo,
                        ...
                        x.BKashNo,
                        x.EmployeeName,
                        new Tuple<string, string, string>(x.InvNo, x.TransactionType, x.Invoice)
                    )
                ));
            }
            else
            {
                ...
                return joinedoAllCustomerCollData.Select(x => new Tuple<DateTime, string, string, string, decimal, decimal, decimal, Tuple<decimal, string, string, string, string, string, string, Tuple<string, string, string>>>
                (
                    (DateTime)x.EntryDate,
                    x.Name,
                    x.Address,
        ...
        //public static List<CashCollectionReportModel> IncomeAdjustment(
        //    this IBaseRepository<CashCollection> CashCollectionRepository,
        //    IBaseRepository<Customer> CustomerRepository,
        //    DateTime fromDate, DateTime toDate, int ConcernID)
        //{
        //    IQueryable<Customer> customers = ConcernID > 0
        //        ? CustomerRepository.GetAll().Where(i => i.ConcernID == ConcernID)
        ...
        //    return oAllCustomerCollData.ToList();
        //}
