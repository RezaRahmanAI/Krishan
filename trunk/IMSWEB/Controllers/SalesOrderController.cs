...
namespace IMSWEB.Controllers
{
    ...
    public class SalesOrderController : CoreController
    {
        ...
        public SalesOrderController(IErrorService errorService,
            ...
            ISRVisitService SRVisitService, IUserService UserService, ICashCollectionService cashCollectionService,
            IProductService productService, ISisterConcernService sisterConcern, IDepotService DepotService,
            ISystemInformationService SysInfoService, ISMSStatusService SMSStatusService, IProductUnitTypeService productUnitTypeService, ISizeService sizeService, ISMSBillPaymentBkashService smsBillPaymentBkashService)
            : base(errorService)
        {
        ...
        public ActionResult Create(SalesOrderViewModel newSalesOrder, FormCollection formCollection, string returnUrl, string ItemType)
        {
            ViewBag.IsEmployeeWiseTransEnable = _SysInfoService.IsEmployeeWiseTransactionEnable();
            return HandleSalesOrder(newSalesOrder, formCollection, ItemType);
        }
        ...
        public ActionResult Edit(int orderId, string previousAction)
        {
            ...
            if (TempData["salesOrderViewModel"] == null || string.IsNullOrEmpty(previousAction))
            {
                ...
                vm.SalesOrder.PayItems = payItems;

                string payType = string.Empty;
                if (vmSalesOrder.PayCashAccountId.HasValue)
                {
                    vmSalesOrder.ItemId = vmSalesOrder.PayCashAccountId.ToString();
                    payType = "CA";
                }
                else if (vmSalesOrder.PayBankId.HasValue)
                {
                    vmSalesOrder.ItemId = vmSalesOrder.PayBankId.ToString();
                    payType = "B";
                }
        ...
        {
            ViewBag.IsEmployeeWiseTransEnable = _SysInfoService.IsEmployeeWiseTransactionEnable();
            return HandleSalesOrder(newSalesOrder, formCollection, string.Empty);
        }
        ...
        public ActionResult Delete(int orderId)
        {
            ...
            if (Result == true)
            {
                AddToastMessage("", "Delete Not Possible Return. Found.", ToastType.Error);
                return RedirectToAction("Index");
            }
        ...
        private void CheckAndAddModelErrorForSave(SalesOrderViewModel newSalesOrder, SalesOrderViewModel salesOrder, FormCollection formCollection)
        {
            ...
            if (string.IsNullOrEmpty(newSalesOrder.SalesOrder.ItemId))
            {
                ModelState.AddModelError("SalesOrder.ItemId", "Payment type is required!");
            }
            ...
            if (newSalesOrder.SalesOrder.TermsType == 0)
            {
                ...
                AddToastMessage("", "Sales Type is required. ", ToastType.Error);
            }
            ...
            SalesOrderViewModel salesOrder, FormCollection formCollection)
        {
            ...
            DateTime RDate = Convert.ToDateTime(formCollection["OrderDate"]);
            salesOrder.SalesOrder.RemindDate = RDate.AddDays(15).ToString();
            ...
            SalesOrderViewModel salesOrder, FormCollection formCollection)
        {
            ...
            //salesOrder.SalesOrder.DepotId = formCollection["DepotsId"];
            salesOrder.SalesOrder.TermsType = newSalesOrder.SalesOrder.TermsType;
            salesOrder.SalesOrder.CartonPercentage = newSalesOrder.SalesOrder.CartonPercentage;
            salesOrder.SalesOrder.AfterCartonAmt = newSalesOrder.SalesOrder.AfterCartonAmt;
            salesOrder.SalesOrder.AfterCashAmt = newSalesOrder.SalesOrder.AfterCashAmt;
            salesOrder.SalesOrder.AfterYearlyAmt = newSalesOrder.SalesOrder.AfterYearlyAmt;
            salesOrder.SalesOrder.CartonAmt = newSalesOrder.SalesOrder.CartonAmt;
            salesOrder.SalesOrder.CashBPercentage = newSalesOrder.SalesOrder.CashBPercentage;
            salesOrder.SalesOrder.CashBAmt = newSalesOrder.SalesOrder.CashBAmt;
            salesOrder.SalesOrder.YearlyBPercentage = newSalesOrder.SalesOrder.YearlyBPercentage;
            salesOrder.SalesOrder.YearlyBnsAmt = newSalesOrder.SalesOrder.YearlyBnsAmt;
            ...
            if (ControllerContext.RouteData.Values["action"].ToString().ToLower().Equals("edit"))
            {
                Result = _salesOrderService.UpdateSalesOrderUsingSP(User.Identity.GetUserId<int>(), int.Parse(salesOrder.SalesOrder.SalesOrderId),
                 dtSalesOrder, dtSalesOrderDetail, Convert.ToInt32(salesOrder.SalesOrder.EmployeeID));
                if (Result)
                {
            ...
            else
            {
                ...
                Result = _salesOrderService.AddSalesOrderUsingSP(dtSalesOrder, dtSalesOrderDetail, RemindDate, Convert.ToInt32(salesOrder.SalesOrder.EmployeeID));
        ...
        private DataTable CreateSalesOrderDataTable(SalesOrderViewModel salesOrder)
        {
            ...
            dtSalesOrder.Columns.Add("CartonPercentage", typeof(decimal));
            dtSalesOrder.Columns.Add("CartonAmt", typeof(decimal));
            dtSalesOrder.Columns.Add("CashBPercentage", typeof(decimal));
            dtSalesOrder.Columns.Add("CashBAmt", typeof(decimal));
            dtSalesOrder.Columns.Add("YearlyBPercentage", typeof(decimal));
            dtSalesOrder.Columns.Add("YearlyBnsAmt", typeof(decimal));
            dtSalesOrder.Columns.Add("AfterCartonAmt", typeof(decimal));
            dtSalesOrder.Columns.Add("AfterCashAmt", typeof(decimal));
            dtSalesOrder.Columns.Add("AfterYearlyAmt", typeof(decimal));
            ...
            row["DepotId"] = 0;
            row["Terms"] = salesOrder.SalesOrder.TermsType;
            ...
            row["CartonPercentage"] = GetDefaultIfNull(salesOrder.SalesOrder.CartonPercentage);
            row["CartonAmt"] = GetDefaultIfNull(salesOrder.SalesOrder.CartonAmt);
            row["CashBPercentage"] = GetDefaultIfNull(salesOrder.SalesOrder.CashBPercentage);
            row["CashBAmt"] = GetDefaultIfNull(salesOrder.SalesOrder.CashBAmt);
            row["YearlyBPercentage"] = GetDefaultIfNull(salesOrder.SalesOrder.YearlyBPercentage);
            row["YearlyBnsAmt"] = GetDefaultIfNull(salesOrder.SalesOrder.YearlyBnsAmt);
            row["AfterCartonAmt"] = GetDefaultIfNull(salesOrder.SalesOrder.AfterCartonAmt);
            row["AfterCashAmt"] = GetDefaultIfNull(salesOrder.SalesOrder.AfterCashAmt);
            row["AfterYearlyAmt"] = GetDefaultIfNull(salesOrder.SalesOrder.AfterYearlyAmt);
        ...
        private ActionResult ReturnCreateViewWithTempData()
        {
            ...
            if (salesOrder != null)
            {
                ...
                salesOrder.SalesOrder.PayItems = payItems;
                TempData["salesOrderViewModel"] = salesOrder;
            ...
            else
            {
                ...
                return View(new SalesOrderViewModel
                {
                    ...
                    SalesOrder = new CreateSalesOrderViewModel { InvoiceNo = invNo, PayItems = payItems, ItemId = fpay.ExpenseItemID.ToString(), EmployeeID = EmployeeID.ToString() }
                });
            }
        }
        ...
        private ActionResult HandleSalesOrder(SalesOrderViewModel newSalesOrder, FormCollection formCollection, string ItemType)
        {
            ViewBag.ProductIds = GetAllProductsForDDL();
            ViewBag.CustomerIds = GetAllCustomerForDDL();
            ViewBag.EmployeeIds = GetAllEmployeeForDDL();
            ...
            if (newSalesOrder != null)
            {
                ...
                if (formCollection.Get("addButton") != null)
                {
                    ...
                    ModelState.Remove("SODetail.TotalArea");
                ...
                else if (formCollection.Get("submitButton") != null)
                {
                    ...
                    salesOrder.SalesOrder.PayCashAccountId = ItemType.Equals("CA") ? int.Parse(newSalesOrder.SalesOrder.ItemId) : (int?)null;
                    salesOrder.SalesOrder.PayBankId = ItemType.Equals("B") ? int.Parse(newSalesOrder.SalesOrder.ItemId) : (int?)null;
        ...
        [HttpGet]
        [Authorize]
        public ActionResult MOWiseProductSalesReport()
        {
            return View("MOWiseProductSalesReport");
        }
        ...
        [HttpGet]
        [Authorize]
        public JsonResult GetCustomerSalesById(int customerId)
        {
            var sales = (from sale in _salesOrderService.GetAllIQueryable()
                         where sale.CustomerID == customerId &&
                         sale.PaymentDue != sale.CCAdjustment + sale.CCAmount
                         select new
                         {
                             InvoiceNo = sale.InvoiceNo,
                             SOrderID = sale.SOrderID,
                             PaymentsDue = sale.PaymentDue - (sale.CCAmount + sale.CCAdjustment),
        ...
        [HttpGet]
        [Authorize]
        public ActionResult SRWiseSaleCollectionReport()
        {
            return View();
        }
        ...
        [HttpGet]
        [Authorize]
        public ActionResult BankAndCashAccountLedger()
        {
            var allHeads = _cashCollectionService.GetAllPayTypeHeadForPO().Select(s => new SelectListItem { Text = s.Name, Value = s.ExpenseItemID.ToString() }).ToList();
            return View(new CreateSalesOrderViewModel() { PayHeads = allHeads });
            //return View();
        }

        [HttpGet]
        public ActionResult ReceiptPaymentReport()
        {
            return View();
        }
        ...
        [HttpGet]
        [Authorize]
        public ActionResult CompanyIncomeStatementReport()
        {
            ViewBag.Title = "Company Income Statement Report";
            return View();
        }
