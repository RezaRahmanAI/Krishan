...
{
    [Authorize]
    public class ProductionController : CoreController
    {
        IMapper _mapper;
        ...
        public ProductionController(IErrorService errorService, IProductionService ProductionSetupService,
        ...
        public ActionResult Create(ProductionViewModel newProduction, FormCollection formcollection)
        {
            ...
            else if (formcollection.Get("btnSave") != null)
            {
                ...
                var Result = _ProductionService.Add(oNewPS, Convert.ToInt32(newProduction.ProductionID));
                if (Result.Item1)
                {
