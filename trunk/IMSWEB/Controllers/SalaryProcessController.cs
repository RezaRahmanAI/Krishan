...
namespace IMSWEB.Controllers
{
    ...
    public class SalaryProcessController : CoreController
    {
        ...
        public SalaryProcessController(IErrorService errorService,
            ...
            IEmployeeTargetSetupService EmployeeTargetSetupService)
            : base(errorService)
        {
        ...
        public ActionResult ProcessSalary(SalaryProcessViewModel model, FormCollection formcollection)
        {
            ...
            EmployeeTargetSetup EmployeeTarget = null;
            ...
            EmployeeTarget = _EmployeeTargetSetupService.GetAll().FirstOrDefault(i => i.TargetMonth >= DateRange.Item1 && i.TargetMonth <= DateRange.Item2);
            ...
            foreach (var employeeID in EmployeeIDList)
            {
                ...
                EmployeeTarget = _EmployeeTargetSetupService.GetByEmployeeIDandTargetMonth(employeeID, DateRange.Item1, DateRange.Item2);
